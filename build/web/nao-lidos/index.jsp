                    ...
                    <section class="py-4 text-center container">
                        <div class="row py-lg-3">
                            <div class="col-lg-9 col-md-8 mx-auto">
                                <h1 class="fw-light">Livros não Lidos</h1>
                                <p class="lead text-body-secondary">
                                    Explore todos os livros não lidos da sua coleção pessoal em um único lugar.
                        ...
                        <div class="container-fluid">
                            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-4 g-3">
                                <%
                                    ...
                                    List<Book> books = controller.getAllUnreadBooks();
