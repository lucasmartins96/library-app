                    ...
                    <section class="py-4 text-center container">
                        <div class="row py-lg-3">
                            <div class="col-lg-9 col-md-8 mx-auto">
                                <h1 class="fw-light">Livros em Leitura</h1>
                                <p class="lead text-body-secondary">
                                    Explore todos os livros em leitura da sua coleção pessoal em um único lugar.
                        ...
                        <div class="container-fluid">
                            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-4 g-3">
                                <%
                                    ...
                                    List<Book> books = controller.getAllInProgressReadBooks();
                                ...
                                <div class="col">
                                    <div class="card shadow-sm">
                                        <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">MyLibraryApp</text></svg>
                                        <div class="card-body">
